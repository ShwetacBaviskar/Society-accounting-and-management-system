...
namespace Sociatyacc
{
    public partial class member : System.Web.UI.Page
    {
        ...
        {
            string query = "INSERT INTO flat VALUES(@id,@societyid,@BuildingName,@flatnumber,@flatareaInSqft,@FlatType)";
            string constr =
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand(query))
                {
                    ...
                    cmd.Parameters.AddWithValue("@BuildingName", TextBox3.Text);
                    cmd.Parameters.AddWithValue("@flatnumber", TextBox4.Text);
                    cmd.Parameters.AddWithValue("@flatareaInSqft", TextBox5.Text);
                    cmd.Parameters.AddWithValue("@FlatType", TextBox6.Text);
